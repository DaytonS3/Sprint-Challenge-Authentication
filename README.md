...
What is the purpose of using sessions?
  ...
  Sessions allow users to not have to login constantly during a certain period of time. It is also used for authentication by   getting user data and storing it as a cookie.


What does bcrypt do to help us store passwords in a secure manner.

  Bcrpyt encrypts the users password by hashing it.


What does bcrypt do to slow down attackers?

  Can hash a users password as many times that you want
